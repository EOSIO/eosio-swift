...
public protocol EosioAbiProviderProtocol {
    ...
    */
    func getAbis(chainId: String, accounts: [EosioName], completion: @escaping (EosioResult<[EosioName:Data]>) -> Void)
    ...
    */
    func getAbi(chainId: String, account: EosioName, completion: @escaping (EosioResult<Data>) -> Void)
